...
jQuery(document).ready(function($){
	...
	window.mapAPI_Loaded = function() {
		...
		for(var i = 0; i < $('.wstock-google-map').length; i++) {
			 infoWindows[i] = [];
		}

		$('.wstock-google-map').each(function(i){
	...
	if(typeof google === 'object' && typeof google.maps === 'object') {
 		...
 		if(woodstock_scripts_vars.mapApiKey.length > 0) {
 			$.getScript('https://maps.google.com/maps/api/js?sensor=false&key='+woodstock_scripts_vars.mapApiKey+'&callback=mapAPI_Loaded');
 		} else {
