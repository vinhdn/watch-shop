...
function shortcode_google_map($atts, $content=null, $code) {
    ...
    wp_enqueue_script('woodstockMap', get_template_directory_uri() . '/js/map.js', array('jquery'), '1.0', TRUE);
