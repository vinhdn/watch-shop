						...
						<div class="gr-price">
							<div class="label">
								<label for="product-<?php echo $grouped_product->get_id(); ?>">
									<?php echo $product->is_visible() ? '<h4><a href="' . esc_url( apply_filters( 'woocommerce_grouped_product_list_link', get_permalink(), $grouped_product->get_id() ) ) . '">' . get_the_title() . '</h4></a>' : get_the_title(); ?>
								</label>
							</div>
