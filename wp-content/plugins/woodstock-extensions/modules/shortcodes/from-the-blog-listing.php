					...
					<a class="blog_list_img_link" href="<?php the_permalink(); ?>">
						...
						<span class="blog-list-content-wrapper">
							<span class="blog-list-content-inner">
								<span class="blog-list-comment"><i class="fa fa-comment-o"><span><?php comments_number('0', '1', '%' );?></span></i></span>

								<!-- <span class="blog-list-day"><?php echo get_the_time('d'); ?></span>
 -->								
								<span class="blog-list-content">
									<h2 class="blog-list-title"><?php echo get_the_title(); ?></h2>
									<span class="blog-list-date"><?php echo get_the_time('d'); ?> <?php echo get_the_time('F'); ?> <?php echo get_the_time('Y'); ?></span>
